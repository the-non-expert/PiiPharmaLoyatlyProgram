...
<div class="pg" style="padding:28px 36px;font-family:'Montserrat',sans-serif;max-width:780px;">
	...
	<!-- Retailer card -->
	<div style="background:#fff;border-radius:10px;border:1px solid #EAEAEA;padding:18px 20px;margin-bottom:16px;box-shadow:0 1px 4px rgba(0,0,0,0.04);">
		...
		<div class="stats-strip" style="display:flex;gap:0;border-top:1px solid #F0F0F0;padding-top:12px;">
	...
	<!-- Product info strip -->
	<div style="background:#F4F6F8;border-radius:8px;padding:12px 16px;margin-bottom:16px;display:flex;gap:24px;flex-wrap:wrap;">
	...
	<div style="background:#fff;border-radius:10px;border:1px solid #EAEAEA;overflow:hidden;margin-bottom:16px;box-shadow:0 1px 4px rgba(0,0,0,0.04);">
